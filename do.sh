...
| xargs ./node_modules/bs-platform/bin/bsc.exe -ppx ./node_modules/reason/reactjs_jsx_ppx.native -bin-annot -pp ./node_modules/reason/refmt_impl.native -I src/ -I src/utils/

foo=$(./node_modules/.bin/babel --plugins transform-react-createelement-to-jsx ./src/index.js \
